var callBackGetSuccess = function(data) {
    ...
    element.innerHTML = "<h3>Boites de production : </h3>" + "<p>" + data.production_companies[0].name + "</p>" + "<p>" + data.production_companies[1].name + "</p>" + "</br>" ;
...
var url = "https://api.themoviedb.org/3/movie/68718?api_key=0bee5e1868fb90c11b6992925fc67e0b&language=fr"
